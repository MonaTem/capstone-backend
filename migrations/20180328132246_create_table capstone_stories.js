...
exports.up = function(knex, Promise) {
    ...
    function createStoryBeginningTable() {
          return knex.raw('CREATE TABLE story_beginning_table (id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, story_beginning_snippet text, char_id int REFERENCES main_character(id) ON DELETE CASCADE)');
     }
