exports.seed =  async function(knex, Promise) {
  ...
  await knex.raw("INSERT INTO happy_ending (happy_ending_snippet, char_id) VALUES ('The bears pursuer took to his heels and ran away as fast as he could.  The bear ambled away happily and resumed his fishing and berry hunting. Everyone lived happily ever after', 1)");
  await knex.raw("INSERT INTO sad_ending (sad_ending_snippet, char_id) VALUES ('The bears pursuer turned and shot an arrow into the bear. The bear did not die right away, but he roared in pain and struck out at the human with his claws.  The human died on the spot.  No one lived happily ever after', 1)");
};
